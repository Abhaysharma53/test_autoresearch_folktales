...
EMBEDDING_LR = 1.0      # learning rate for token embeddings (Adam) - increased from 0.9
...
WARMDOWN_RATIO = 0.4    # fraction of time budget for LR warmdown (reduced from 0.5)
